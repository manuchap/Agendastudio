...
;(function ( $, window, document, undefined ) {
  ...
  var pluginName = 'Calendar',
    ...
    defaults = {
      weekStart: 1,
      msg_days: ["Di", "Lu", "Ma", "Me", "Je", "Ve", "Sa"],
      msg_months: ["Janvier", "Fevrier", "Mars", "Avril", "Mai", "Juin", "Juillet", "Aout", "Septembre", "Octobre", "Novembre", "Decembre"],
      msg_today: 'Aujourd\'hui',
      msg_events_header: 'Réservé par',
      events: null
    },
    ...
    template =  ''+
            ...
            '<table class="calendar" id="calendar">'+
              ...
              '<tfoot>'+
                '<th colspan="2" class="sel" id="last">Préced.</th>'+
                '<th colspan="3" class="sel" id="current">%msg_today%</th>'+
                '<th colspan="2" class="sel" id="next">Suiv.</th>'+
              '</tfoot>'+
            '</table>'+
          '',
